...
variable "resource_names" {
  ...
  type = object({
    ...
    version_control_system_team                                 = optional(string, "{{service_name}}-{{environment_name_long}}-approvers")
    version_control_system_runner_group                         = optional(string, "{{service_name}}-{{environment_name_long}}")
